...
export class LineaComponent {
  ...
  public changeLabel() {
    this.lineChartLabels[0] = ['January'];
    this.lineChartLabels[1] = ['February'];
    this.lineChartLabels[2] = ['March'];
    this.lineChartLabels[3] = ['April'];
    this.lineChartLabels[4] = ['May'];
    this.lineChartLabels[5] = ['June'];
    this.lineChartLabels[6] = ['July'];
    // this.chart.update();
  }
}
